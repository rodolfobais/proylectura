...
class Smarty extends Smarty_Internal_TemplateBase
{
    ...
    public function __construct()
    {
        ...
        // set default dirs
        $this->setTemplateDir('.' . DS . '/data/smarty/templates' . DS)
            ->setCompileDir('.' . DS . '/data/smarty/templates_c' . DS)
            ->setPluginsDir(SMARTY_PLUGINS_DIR)
            ->setCacheDir('.' . DS . '/data/smarty/cache' . DS)
            ->setConfigDir('.' . DS . '/data/smarty/configs' . DS);
