...
abstract class BaseUsuarioPeer {
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Nick', 'Nombre', 'mail', 'Password', 'Admin', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'nick', 'nombre', 'mail', 'password', 'admin', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NICK, self::NOMBRE, self::MAIL, self::PASSWORD, self::ADMIN, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NICK', 'NOMBRE', 'MAIL', 'PASSWORD', 'ADMIN', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'nick', 'nombre', 'mail', 'password', 'admin', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Nick' => 1, 'Nombre' => 2, 'mail' => 3, 'Password' => 4, 'Admin' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'nick' => 1, 'nombre' => 2, 'mail' => 3, 'password' => 4, 'admin' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NICK => 1, self::NOMBRE => 2, self::MAIL => 3, self::PASSWORD => 4, self::ADMIN => 5, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NICK' => 1, 'NOMBRE' => 2, 'MAIL' => 3, 'PASSWORD' => 4, 'ADMIN' => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'nick' => 1, 'nombre' => 2, 'mail' => 3, 'password' => 4, 'admin' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(UsuarioPeer::NICK);
			$criteria->addSelectColumn(UsuarioPeer::NOMBRE);
			$criteria->addSelectColumn(UsuarioPeer::MAIL);
