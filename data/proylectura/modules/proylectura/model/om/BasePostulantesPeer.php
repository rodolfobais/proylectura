...
abstract class BasePostulantesPeer {
	...
	const ID = 'postulantes.ID';

	/** the column name for the ID_LIBRO field */
	const ID_LIBRO = 'postulantes.ID_LIBRO';

	/** the column name for the ID_POSTULANTE field */
	const ID_POSTULANTE = 'postulantes.ID_POSTULANTE';

	/** the column name for the ESTADO field */
	const ESTADO = 'postulantes.ESTADO';

	/** The default string format for model objects of the related table **/
	const DEFAULT_STRING_FORMAT = 'YAML';

	/**
	 * An identiy map to hold any loaded instances of Postulantes objects.
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Id_libro', 'Id_postulante', 'Estado', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'id_libro', 'id_postulante', 'estado', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::ID_LIBRO, self::ID_POSTULANTE, self::ESTADO, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'ID_LIBRO', 'ID_POSTULANTE', 'ESTADO', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'id_libro', 'id_postulante', 'estado', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Id_libro' => 1, 'Id_postulante' => 2, 'Estado' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'id_libro' => 1, 'id_postulante' => 2, 'estado' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::ID_LIBRO => 1, self::ID_POSTULANTE => 2, self::ESTADO => 3, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'ID_LIBRO' => 1, 'ID_POSTULANTE' => 2, 'ESTADO' => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'id_libro' => 1, 'id_postulante' => 2, 'estado' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	{
		if (null === $alias) {
			$criteria->addSelectColumn(PostulantesPeer::ID);
			$criteria->addSelectColumn(PostulantesPeer::ID_LIBRO);
			$criteria->addSelectColumn(PostulantesPeer::ID_POSTULANTE);
			$criteria->addSelectColumn(PostulantesPeer::ESTADO);
		} else {
	 ...
	 *
	 * @param      Postulantes $value A Postulantes object.
	...
	public static function doCountJoinLibro(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(PostulantesPeer::ID_LIBRO, LibroPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Postulantes objects pre-filled with their Libro objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinLibro(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Postulantes) to $obj2 (Libro)
	...
	/**
	 * Selects a collection of Postulantes objects pre-filled with their Usuario objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Postulantes objects.
	...
	public static function doSelectJoinUsuario(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Postulantes) to $obj2 (Usuario)
				$obj2->addPostulantes($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Postulantes) to the collection in $obj2 (Libro)
				$obj2->addPostulantes($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Postulantes) to the collection in $obj3 (Usuario)
	...
	/**
	 * Selects a collection of Postulantes objects pre-filled with all related objects except Usuario.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(PostulantesPeer::ID) && $criteria->keyContainsValue(PostulantesPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.PostulantesPeer::ID.')');
		}
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(PostulantesPeer::ID);
			$value = $criteria->remove(PostulantesPeer::ID);
			if ($value) {
				$selectCriteria->add(PostulantesPeer::ID, $value, $comparison);
			} else {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(PostulantesPeer::ID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(PostulantesPeer::ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(PostulantesPeer::DATABASE_NAME);
			$criteria->add(PostulantesPeer::ID, $pks, Criteria::IN);
