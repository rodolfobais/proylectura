...
abstract class BaseSolicitudPeer {
	 ...
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 * @return     array (Solicitud object, last column rank)
	 */
	public static function populateObject($row, $startcol = 0)
	{
		$key = SolicitudPeer::getPrimaryKeyHashFromRow($row, $startcol);
		if (null !== ($obj = SolicitudPeer::getInstanceFromPool($key))) {
			// We no longer rehydrate the object, since this can cause data loss.
			// See http://www.propelorm.org/ticket/509
			// $obj->hydrate($row, $startcol, true); // rehydrate
			$col = $startcol + SolicitudPeer::NUM_HYDRATE_COLUMNS;
		} else {
			$cls = SolicitudPeer::OM_CLASS;
			$obj = new $cls();
	...
	/**
	 * Selects a collection of Solicitud objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	{
		return SolicitudPeer::OM_CLASS;
	}

	/**
	 * Performs an INSERT on the database, given a Solicitud or Criteria object.
	 *
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(SolicitudPeer::ID) && $criteria->keyContainsValue(SolicitudPeer::ID) ) {
	...
	/**
	 * Performs an UPDATE on the database, given a Solicitud or Criteria object.
	 *
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(SolicitudPeer::ID);
			$value = $criteria->remove(SolicitudPeer::ID);
			if ($value) {
				$selectCriteria->add(SolicitudPeer::ID, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(SolicitudPeer::TABLE_NAME);
			}
	...
	/**
	 * Deletes all rows from the solicitud table.
	 *
	 * @param      PropelPDO $con the connection to use
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(SolicitudPeer::TABLE_NAME, $con, SolicitudPeer::DATABASE_NAME);
	...
	/**
	 * Performs a DELETE on the database, given a Solicitud or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(SolicitudPeer::ID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(SolicitudPeer::ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(SolicitudPeer::DATABASE_NAME);
			$criteria->add(SolicitudPeer::ID, $pks, Criteria::IN);
