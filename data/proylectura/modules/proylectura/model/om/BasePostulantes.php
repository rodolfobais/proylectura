...
abstract class BasePostulantes extends BaseObject  implements Persistent
{
	 ...
	 * @return     int
	 */
	public function getId_postulante()
	{
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = PostulantesPeer::ID;
		}
	...
	public function setId_libro($v)
	{
		...
		if ($this->id_libro !== $v) {
			$this->id_libro = $v;
			$this->modifiedColumns[] = PostulantesPeer::ID_LIBRO;
		}
	 ...
	 * @return     Postulantes The current object (for fluent API support)
	 */
	public function setId_postulante($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}
		...
		if ($this->id_postulante !== $v) {
			...
			$this->modifiedColumns[] = PostulantesPeer::ID_POSTULANTE;
		}
	...
	public function setEstado($v)
	{
		...
		if ($this->estado !== $v) {
			$this->estado = $v;
			$this->modifiedColumns[] = PostulantesPeer::ESTADO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_postulante = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			...
			return $startcol + 4; // 4 = PostulantesPeer::NUM_HYDRATE_COLUMNS.
	...
	public function ensureConsistency()
	{
		...
		if ($this->aUsuario !== null && $this->id_postulante !== $this->aUsuario->getId()) {
			$this->aUsuario = null;
		}
	} // ensureConsistency
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(PostulantesPeer::ID)) {
			$modifiedColumns[':p' . $index++]  = '`ID`';
		}
		if ($this->isColumnModified(PostulantesPeer::ID_LIBRO)) {
			$modifiedColumns[':p' . $index++]  = '`ID_LIBRO`';
		}
		if ($this->isColumnModified(PostulantesPeer::ID_POSTULANTE)) {
			$modifiedColumns[':p' . $index++]  = '`ID_POSTULANTE`';
		}
		if ($this->isColumnModified(PostulantesPeer::ESTADO)) {
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setId_postulante($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PostulantesPeer::ID)) $criteria->add(PostulantesPeer::ID, $this->id);
		if ($this->isColumnModified(PostulantesPeer::ID_LIBRO)) $criteria->add(PostulantesPeer::ID_LIBRO, $this->id_libro);
		if ($this->isColumnModified(PostulantesPeer::ID_POSTULANTE)) $criteria->add(PostulantesPeer::ID_POSTULANTE, $this->id_postulante);
		if ($this->isColumnModified(PostulantesPeer::ESTADO)) $criteria->add(PostulantesPeer::ESTADO, $this->estado);
	...
	{
		$criteria = new Criteria(PostulantesPeer::DATABASE_NAME);
		$criteria->add(PostulantesPeer::ID, $this->id);
	...
	public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
	{
		...
		$copyObj->setId_postulante($this->getId_postulante());
	...
	public function getLibro(PropelPDO $con = null)
	{
		if ($this->aLibro === null && ($this->id_libro !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aLibro->addPostulantess($this);
			 */
		}
		return $this->aLibro;
	}
	...
	{
		if ($v === null) {
			$this->setId_postulante(NULL);
		} else {
			$this->setId_postulante($v->getId());
		}
	...
	{
		if ($this->aUsuario === null && ($this->id_postulante !== null)) {
			$this->aUsuario = UsuarioQuery::create()->findPk($this->id_postulante, $con);
			/* The following can be used additionally to
				guarantee the related object contains a reference
				to this object.  This level of coupling may, however, be
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aUsuario->addPostulantess($this);
			 */
		}
