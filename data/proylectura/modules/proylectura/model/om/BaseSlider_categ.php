...
/**
 * Base class that represents a row from the 'slider_categ' table.
 *
 * 
 *
 * @package    propel.generator.proylectura.model.om
 */
abstract class BaseSlider_categ extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Slider_categPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Slider_categPeer
	 */
	 ...
	 * @return     Slider_categ The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = Slider_categPeer::ID;
		}
	...
	public function setDescrp($v)
	{
		...
		if ($this->descrp !== $v) {
			$this->descrp = $v;
			$this->modifiedColumns[] = Slider_categPeer::DESCRP;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = Slider_categPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Slider_categ object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Slider_categPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Slider_categQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Slider_categPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Slider_categPeer::ID)) {
			$modifiedColumns[':p' . $index++]  = '`ID`';
		}
		if ($this->isColumnModified(Slider_categPeer::DESCRP)) {
			$modifiedColumns[':p' . $index++]  = '`DESCRP`';
		}

		$sql = sprintf(
			'INSERT INTO `slider_categ` (%s) VALUES (%s)',
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Slider_categPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Slider_categPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Slider_categ'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Slider_categ'][$this->getPrimaryKey()] = true;
		$keys = Slider_categPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Slider_categPeer::ID)) $criteria->add(Slider_categPeer::ID, $this->id);
		if ($this->isColumnModified(Slider_categPeer::DESCRP)) $criteria->add(Slider_categPeer::DESCRP, $this->descrp);
	...
	{
		$criteria = new Criteria(Slider_categPeer::DATABASE_NAME);
		$criteria->add(Slider_categPeer::ID, $this->id);
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Slider_categ Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Slider_categPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Slider_categPeer();
		}
		return self::$peer;
	}
	 ...
	 * If this Slider_categ is new, it will return
	...
	public function setSlider_maes(PropelCollection $slider_maes, PropelPDO $con = null)
	{
		...
		foreach ($slider_maes as $slider_mae) {
			...
			if ($slider_mae->isNew()) {
				$slider_mae->setSlider_categ($this);
			}
	...
	{
		return (string) $this->exportTo(Slider_categPeer::DEFAULT_STRING_FORMAT);
	}
