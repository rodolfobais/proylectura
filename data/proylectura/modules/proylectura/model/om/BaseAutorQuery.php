 ...
 *
 * @method     Autor findOneById(int $id) Return the first Autor filtered by the id column
...
abstract class BaseAutorQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'proylectura', $modelName = 'Autor', $modelAlias = null)
	{
	...
	{
		$sql = 'SELECT `ID`, `NOMBRE` FROM `autor` WHERE `ID` = :p0';
		try {
