...
abstract class BaseSolicitud extends BaseObject  implements Persistent
{
	...
	public function setId_usuario_solicitado($v)
	{
		...
		if ($this->id_usuario_solicitado !== $v) {
			...
			$this->modifiedColumns[] = SolicitudPeer::ID_USUARIO_SOLICITADO;
		}
	...
	public function setEstado($v)
	{
		...
		if ($this->estado !== $v) {
			$this->estado = $v;
			$this->modifiedColumns[] = SolicitudPeer::ESTADO;
		}
	...
	public function setFecha($v)
	{
		...
		if ($this->fecha !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = SolicitudPeer::FECHA;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = SolicitudPeer::NUM_HYDRATE_COLUMNS.
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(SolicitudPeer::ID_USUARIO_SOLICITADO)) {
		...
		if ($this->isColumnModified(SolicitudPeer::ESTADO)) {
			$modifiedColumns[':p' . $index++]  = '`ESTADO`';
		}
		if ($this->isColumnModified(SolicitudPeer::FECHA)) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SolicitudPeer::ID_USUARIO_SOLICITADO)) $criteria->add(SolicitudPeer::ID_USUARIO_SOLICITADO, $this->id_usuario_solicitado);
		...
		if ($this->isColumnModified(SolicitudPeer::ESTADO)) $criteria->add(SolicitudPeer::ESTADO, $this->estado);
		if ($this->isColumnModified(SolicitudPeer::FECHA)) $criteria->add(SolicitudPeer::FECHA, $this->fecha);
	...
	public function setUsuarioRelatedById_usuario_solicitado(Usuario $v = null)
	{
		...
		if ($v !== null) {
			$v->addSolicitudRelatedById_usuario_solicitado($this);
		}
	...
	public function getUsuarioRelatedById_usuario_solicitado(PropelPDO $con = null)
	{
		if ($this->aUsuarioRelatedById_usuario_solicitado === null && ($this->id_usuario_solicitado !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aUsuarioRelatedById_usuario_solicitado->addSolicitudsRelatedById_usuario_solicitado($this);
			 */
		}
	...
	public function setUsuarioRelatedById_usuario_solicitante(Usuario $v = null)
	{
		...
		// If this object has already been added to the Usuario object, it will not be re-added.
		if ($v !== null) {
			$v->addSolicitudRelatedById_usuario_solicitante($this);
		}
	...
	public function getUsuarioRelatedById_usuario_solicitante(PropelPDO $con = null)
	{
		if ($this->aUsuarioRelatedById_usuario_solicitante === null && ($this->id_usuario_solicitante !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aUsuarioRelatedById_usuario_solicitante->addSolicitudsRelatedById_usuario_solicitante($this);
			 */
		}
