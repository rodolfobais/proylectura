...
abstract class BaseListaPeer {
	...
	const ID_GENERO = 'lista.ID_GENERO';
	...
	public static function doCountJoinUsuario(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ListaPeer::ID_USUARIO, UsuarioPeer::ID, $join_behavior);
	...
	public static function doCountJoinGenero(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ListaPeer::ID_GENERO, GeneroPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Lista objects pre-filled with their Genero objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Lista objects.
	...
	public static function doSelectJoinGenero(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Lista) to $obj2 (Genero)
				$obj2->addLista($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Lista) to the collection in $obj3 (Genero)
				$obj3->addLista($obj1);
			} // if joined row not null
	...
	public static function doSelectJoinAllExceptUsuario(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = ListaPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Lista) to the collection in $obj2 (Genero)
				$obj2->addLista($obj1);
	...
	/**
	 * Selects a collection of Lista objects pre-filled with all related objects except Genero.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(ListaPeer::ID);
			if ($value) {
				$selectCriteria->add(ListaPeer::ID, $value, $comparison);
			} else {
