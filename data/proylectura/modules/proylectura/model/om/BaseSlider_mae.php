...
/**
 * Base class that represents a row from the 'slider_mae' table.
 *
 * 
 *
 * @package    propel.generator.proylectura.model.om
 */
abstract class BaseSlider_mae extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Slider_maePeer';
	...
	public function setId_libro($v)
	{
		...
		if ($this->id_libro !== $v) {
			$this->id_libro = $v;
			$this->modifiedColumns[] = Slider_maePeer::ID_LIBRO;
		}
	...
	public function setPosicion($v)
	{
		...
		if ($this->posicion !== $v) {
			$this->posicion = $v;
			$this->modifiedColumns[] = Slider_maePeer::POSICION;
		}
	 ...
	 * @return     Slider_mae The current object (for fluent API support)
	 */
	public function setId_categoria($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}
		...
		if ($this->id_categoria !== $v) {
			$this->id_categoria = $v;
			$this->modifiedColumns[] = Slider_maePeer::ID_CATEGORIA;
		}

		if ($this->aSlider_categ !== null && $this->aSlider_categ->getId() !== $v) {
			$this->aSlider_categ = null;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->posicion = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			...
			return $startcol + 4; // 4 = Slider_maePeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Slider_mae object", $e);
		}
	}
	...
	public function ensureConsistency()
	{
		...
		if ($this->aSlider_categ !== null && $this->id_categoria !== $this->aSlider_categ->getId()) {
			$this->aSlider_categ = null;
		}
	} // ensureConsistency
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Slider_maePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Slider_maeQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Slider_maePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aSlider_categ !== null) {
				if ($this->aSlider_categ->isModified() || $this->aSlider_categ->isNew()) {
					$affectedRows += $this->aSlider_categ->save($con);
				}
				$this->setSlider_categ($this->aSlider_categ);
			}
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		$sql = sprintf(
			'INSERT INTO `slider_mae` (%s) VALUES (%s)',
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->aSlider_categ !== null) {
				if (!$this->aSlider_categ->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aSlider_categ->getValidationFailures());
				}
			}


			if (($retval = Slider_maePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Slider_maePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Slider_mae'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Slider_mae'][$this->getPrimaryKey()] = true;
		$keys = Slider_maePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getId_libro(),
			$keys[2] => $this->getPosicion(),
			$keys[3] => $this->getId_categoria(),
		);
		if ($includeForeignObjects) {
			if (null !== $this->aLibro) {
				$result['Libro'] = $this->aLibro->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
			}
			if (null !== $this->aSlider_categ) {
				$result['Slider_categ'] = $this->aSlider_categ->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
			}
		}
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setPosicion($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setId_categoria($arr[$keys[3]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Slider_maePeer::ID)) $criteria->add(Slider_maePeer::ID, $this->id);
		if ($this->isColumnModified(Slider_maePeer::ID_LIBRO)) $criteria->add(Slider_maePeer::ID_LIBRO, $this->id_libro);
		if ($this->isColumnModified(Slider_maePeer::POSICION)) $criteria->add(Slider_maePeer::POSICION, $this->posicion);
		if ($this->isColumnModified(Slider_maePeer::ID_CATEGORIA)) $criteria->add(Slider_maePeer::ID_CATEGORIA, $this->id_categoria);
	...
	{
		$criteria = new Criteria(Slider_maePeer::DATABASE_NAME);
		$criteria->add(Slider_maePeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Slider_mae (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
	{
		...
		$copyObj->setId_categoria($this->getId_categoria());
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Slider_mae Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Slider_maePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Slider_maePeer();
		}
		return self::$peer;
	}
	...
	/**
	 * Get the associated Slider_categ object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     Slider_categ The associated Slider_categ object.
	 * @throws     PropelException
	 */
	public function getSlider_categ(PropelPDO $con = null)
	{
		if ($this->aSlider_categ === null && ($this->id_categoria !== null)) {
			$this->aSlider_categ = Slider_categQuery::create()->findPk($this->id_categoria, $con);
			/* The following can be used additionally to
				guarantee the related object contains a reference
				to this object.  This level of coupling may, however, be
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aSlider_categ->addSlider_maes($this);
			 */
		}
		return $this->aSlider_categ;
	}
	...
	{
		return (string) $this->exportTo(Slider_maePeer::DEFAULT_STRING_FORMAT);
	}
