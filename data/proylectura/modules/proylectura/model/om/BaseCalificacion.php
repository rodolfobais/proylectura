...
abstract class BaseCalificacion extends BaseObject  implements Persistent
{
	...
	public function setComentario($v)
	{
		...
		if ($this->comentario !== $v) {
			$this->comentario = $v;
			$this->modifiedColumns[] = CalificacionPeer::COMENTARIO;
		}
	...
	public function setId_lista($v)
	{
		...
		if ($this->id_lista !== $v) {
			$this->id_lista = $v;
			$this->modifiedColumns[] = CalificacionPeer::ID_LISTA;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_lista = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->resetModified();
			...
			return $startcol + 5; // 5 = CalificacionPeer::NUM_HYDRATE_COLUMNS.
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setId_lista($arr[$keys[4]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CalificacionPeer::COMENTARIO)) $criteria->add(CalificacionPeer::COMENTARIO, $this->comentario);
		if ($this->isColumnModified(CalificacionPeer::ID_USUARIO)) $criteria->add(CalificacionPeer::ID_USUARIO, $this->id_usuario);
		if ($this->isColumnModified(CalificacionPeer::ID_LISTA)) $criteria->add(CalificacionPeer::ID_LISTA, $this->id_lista);
