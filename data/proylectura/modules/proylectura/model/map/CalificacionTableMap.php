...
/**
 * This class defines the structure of the 'calificacion' table.
 *
 *
 *
 ...
 */
class CalificacionTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'proylectura.model.map.CalificacionTableMap';
	...
	{
		// attributes
		$this->setName('calificacion');
		$this->setPhpName('Calificacion');
		$this->setClassname('Calificacion');
