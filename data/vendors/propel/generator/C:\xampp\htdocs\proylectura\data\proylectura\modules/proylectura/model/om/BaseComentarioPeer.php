...
abstract class BaseComentarioPeer {
	...
	public static function doCountJoinUsuario(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ComentarioPeer::ID_USUARIO, UsuarioPeer::ID, $join_behavior);
	...
	public static function doCountJoinLibro(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ComentarioPeer::ID_LIBRO, LibroPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Comentario objects pre-filled with their Usuario objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinUsuario(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Comentario) to $obj2 (Usuario)
	...
	/**
	 * Selects a collection of Comentario objects pre-filled with their Libro objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Comentario objects.
	...
	public static function doSelectJoinLibro(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Comentario) to $obj2 (Libro)
				$obj2->addComentario($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Comentario) to the collection in $obj2 (Usuario)
				$obj2->addComentario($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Comentario) to the collection in $obj3 (Libro)
	...
	/**
	 * Selects a collection of Comentario objects pre-filled with all related objects except Usuario.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptUsuario(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = ComentarioPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Comentario) to the collection in $obj2 (Libro)
				$obj2->addComentario($obj1);
	...
	/**
	 * Selects a collection of Comentario objects pre-filled with all related objects except Libro.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
