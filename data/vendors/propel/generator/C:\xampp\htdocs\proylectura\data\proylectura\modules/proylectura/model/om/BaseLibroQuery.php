 ...
 * @method     LibroQuery orderByEstado($order = Criteria::ASC) Order by the estado column
 *
 ...
 * @method     LibroQuery groupByEstado() Group by the estado column
 *
 ...
 * @method     Libro findOneByEstado(string $estado) Return the first Libro filtered by the estado column
 *
 ...
 * @method     array findByEstado(string $estado) Return Libro objects filtered by the estado column
 *
...
abstract class BaseLibroQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID`, `NOMBRE`, `FECHA`, `ID_GENERO`, `AUTOR`, `IMAGE`, `SINOPSIS`, `FECHA_ULT_ACC`, `HORA_ULT_ACC`, `USUARIO_ULT_ACC`, `ID_PRIVACIDAD`, `ES_EDITABLE`, `ID_USUARIO`, `DEBAJA`, `ESTADO` FROM `libro` WHERE `ID` = :p0';
		try {
	...
	public function filterByEstado($estado = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(LibroPeer::ESTADO, $estado, $comparison);
	}
