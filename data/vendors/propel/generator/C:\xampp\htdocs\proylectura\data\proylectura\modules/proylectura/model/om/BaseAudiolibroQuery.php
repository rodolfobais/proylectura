...
/**
 * Base class that represents a query for the 'audiolibro' table.
 *
 * 
 *
 ...
 */
abstract class BaseAudiolibroQuery extends ModelCriteria
{
	
	/**
	 * Initializes internal state of BaseAudiolibroQuery object.
	 *
	 * @param     string $dbName The dabase name
	 * @param     string $modelName The phpName of a model, e.g. 'Book'
	 * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
	 */
	public function __construct($dbName = 'proylectura', $modelName = 'Audiolibro', $modelAlias = null)
	{
	 ...
	 *
	 * @return    Audiolibro|array|mixed the result, formatted by the current formatter
	 */
	public function findPk($key, $con = null)
	{
		...
		if ((null !== ($obj = AudiolibroPeer::getInstanceFromPool((string) $key))) && !$this->formatter) {
	 ...
	 *
	 * @return    Audiolibro A model object, or null if the key is not found
	 */
	protected function findPkSimple($key, $con)
	{
		...
		if ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$obj = new Audiolibro();
			$obj->hydrate($row);
		AudiolibroPeer::addInstanceToPool($obj, (string) $key);
		}
		$stmt->closeCursor();
	...
	{
		return $this->addUsingAlias(AudiolibroPeer::ID, $key, Criteria::EQUAL);
	}
	...
	{
		return $this->addUsingAlias(AudiolibroPeer::ID, $keys, Criteria::IN);
	}
	...
	public function filterById($id = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(AudiolibroPeer::ID, $id, $comparison);
	}
