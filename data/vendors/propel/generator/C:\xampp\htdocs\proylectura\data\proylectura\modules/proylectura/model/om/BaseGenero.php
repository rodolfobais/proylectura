...
abstract class BaseGenero extends BaseObject  implements Persistent
{
	...
	public function setNombre($v)
	{
		...
		if ($this->nombre !== $v) {
			$this->nombre = $v;
			$this->modifiedColumns[] = GeneroPeer::NOMBRE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = GeneroPeer::NUM_HYDRATE_COLUMNS.
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(GeneroPeer::ID)) {
			$modifiedColumns[':p' . $index++]  = '`ID`';
		}
		if ($this->isColumnModified(GeneroPeer::NOMBRE)) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(GeneroPeer::NOMBRE)) $criteria->add(GeneroPeer::NOMBRE, $this->nombre);
