...
--
-- Servidor: localhost
-- Tiempo de generación: 16-12-2015 a las 09:07:13
...
INSERT INTO `calificacion` (`id`, `puntuacion`, `id_usuario`, `id_libro`) VALUES
(1, 4, 23, 23),
(2, 4, 23, 24),
(3, 5, 23, 25),
(4, 5, 23, 38),
...
INSERT INTO `libro` (`id`, `nombre`, `fecha`, `id_genero`, `autor`, `image`, `sinopsis`, `fecha_ult_acc`, `hora_ult_acc`, `usuario_ult_acc`, `id_privacidad`, `es_editable`, `id_usuario`, `debaja`, `estado`) VALUES
(23, 'nombre', '2015-12-08', 16, 'Pepe Argento', 'a33.jpg', 'Inspirada en el universo de Star Trek, viajeros perdidos en un planeta desconocido', NULL, NULL, NULL, 2, 's', 18, NULL, NULL),
(24, 'Documentacion sobre Proyecto Final', '2015-03-13', 16, '11', 'a22.jpg', 'Ensayo de materiales de PVC para utilizacion en laboratorio de microbiologia', NULL, NULL, NULL, NULL, NULL, 18, NULL, NULL),
(25, 'PHP para la Gilada', '2015-03-13', 17, '12', 'a11.jpg', 'Proyecto de educacion de la ciudad de mexico, material docente de calidad educativa', NULL, NULL, NULL, NULL, NULL, 18, 's', NULL),
(26, 'Antes de que los cuelguen', '2015-03-13', 16, '13', 'a33.jpg', 'Inspirada en el universo de Star Trek, viajeros perdidos en un planeta desconocido', NULL, NULL, NULL, NULL, NULL, 18, NULL, NULL),
(27, 'Tesis sobre tabla periodica', '2015-03-15', 16, '16', 'a22.jpg', 'Ensayo de materiales de PVC para utilizacion en laboratorio de microbiologia', NULL, NULL, NULL, NULL, NULL, 18, NULL, NULL),
(28, 'El libro negro de la jardineria', '2015-03-15', 17, '12', 'a11.jpg', 'Proyecto de educacion de la ciudad de mexico, material docente de calidad educativa', NULL, NULL, NULL, NULL, NULL, 18, NULL, NULL),
(29, 'Matematica I', '2015-03-15', 17, '11', 'a33.jpg', 'Inspirada en el universo de Star Trek, viajeros perdidos en un planeta desconocido', NULL, NULL, NULL, NULL, NULL, 18, NULL, NULL),
(30, 'La biblia del bromista', '2015-03-15', 17, '12', 'a22.jpg', 'Ensayo de materiales de PVC para utilizacion en laboratorio de microbiologia', NULL, NULL, NULL, NULL, NULL, 18, NULL, NULL),
(31, 'Las 2 torres', '2015-03-15', 17, '13', 'a11.jpg', 'Proyecto de educacion de la ciudad de mexico, material docente de calidad educativa', NULL, NULL, NULL, NULL, NULL, 18, NULL, NULL),
(32, 'Todo sobre impresoras', '2015-03-16', 16, '11', 'a33.jpg', 'Inspirada en el universo de Star Trek, viajeros perdidos en un planeta desconocido', NULL, NULL, NULL, NULL, NULL, 18, NULL, NULL),
(33, 'mate demo', '2015-03-24', 24, '20', 'a22.jpg', 'Ensayo de materiales de PVC para utilizacion en laboratorio de microbiologia', NULL, NULL, NULL, NULL, NULL, 18, NULL, NULL),
(34, 'pepe argento', '2015-04-02', 20, '20', 'a11.jpg', 'Proyecto de educacion de la ciudad de mexico, material docente de calidad educativa', NULL, NULL, NULL, NULL, NULL, 18, NULL, NULL),
(35, 'test rodo', '2015-12-13', 16, 'test autor', NULL, 'lalalala andaba por ahi lalala', NULL, NULL, NULL, 2, 'n', 18, NULL, NULL),
(36, 'test rodo', '2015-12-13', 16, 'test autor', '36', 'test sinopsis', NULL, NULL, NULL, 2, 'n', 18, NULL, NULL),
(37, 'test rodo 2', '2015-12-13', 16, 'test rodo autor', '37', 'lalala caminando lalala bailando', NULL, NULL, NULL, 2, 'n', 18, NULL, NULL),
(38, 'test rodo 3', '2015-12-13', 16, 'asdasd', '38', 'gagadada', NULL, NULL, NULL, 2, 'n', 18, NULL, NULL),
...
INSERT INTO `mensaje` (`id`, `id_usuario_destinatario`, `id_usuario_remitente`, `mensaje`, `leido`) VALUES
(1, 21, 18, 'saaddasdaadasd', 'n'),
(2, 18, 18, 'wsdfghjk', 'n');
...
INSERT INTO `notificacion` (`id`, `id_emisor`, `id_receptor`, `descripcion`, `id_tipo_notificacion`, `leido`) VALUES
(1, 18, 18, '<span onclick="refreshDivs(''cuerpocentro'',''pages/layout/perfillibro.php'',''id=38'')">El usuario ''admin'' ha subido un libro.</span>', 6, 's'),
(2, 18, 18, 'Tu libro ''PHP para la Gilada'' ha sido bloqueado por el administrador.', 9, 's');
...
CREATE TABLE IF NOT EXISTS `solicitud_amistad` (
  ...
  PRIMARY KEY (`id`),
  KEY `FI_icitud_amistad_usuario_solicitado` (`id_usuario_solicitado`),
  KEY `FI_icitud_amistad_usuario_solicitante` (`id_usuario_solicitante`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
INSERT INTO `tipo_notificacion` (`id`, `nombre`, `imagen`) VALUES
(1, 'Guardar version', ''),
(2, 'Comentario de libro', ''),
(3, 'Postulacion en clasificados', ''),
(4, 'Publicacion de un libro', ''),
(5, 'Aceptacion de amistad', ''),
(6, 'Subir un pdf', ''),
(7, 'Denuncia', ''),
(8, 'Recomendacion de libro', ''),
(9, 'Bloqueo de libro', '');
...
INSERT INTO `usuario` (`id`, `nombre`, `mail`, `password`, `admin`, `educacion`, `lugar`, `nota`, `estado`) VALUES
(16, 'Tecla', 'tecla@tecla.com', 'drodriguez', 0, NULL, NULL, NULL, NULL),
(17, 'Fer', 'fer@fer.com', '123456', 0, NULL, NULL, NULL, NULL),
(18, 'admin', 'admin@admin.com', 'admin', 1, NULL, NULL, NULL, NULL),
(20, 'Jorge Miranda', 'jorge@jorge.com', '12345', 0, NULL, NULL, NULL, NULL),
(21, 'Rodo', 'rodo@rodo.com', '123456', 0, NULL, NULL, NULL, NULL),
(22, 'Chris', 'chris@chris.com', '123456', 0, NULL, NULL, NULL, NULL),
(23, 'test', 'asd@asd.com', 'asd', 0, NULL, NULL, NULL, NULL);
...
ALTER TABLE `solicitud_amistad`
  ADD CONSTRAINT `solicitud_amistad_usuario_solicitado` FOREIGN KEY (`id_usuario_solicitado`) REFERENCES `usuario` (`id`),
  ADD CONSTRAINT `solicitud_amistad_usuario_solicitante` FOREIGN KEY (`id_usuario_solicitante`) REFERENCES `usuario` (`id`);
