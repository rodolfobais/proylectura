...
--
-- Servidor: localhost
-- Tiempo de generación: 08-12-2015 a las 16:33:43
...
INSERT INTO `libro` (`id`, `nombre`, `fecha`, `id_genero`, `autor`, `image`, `sinopsis`, `fecha_ult_acc`, `hora_ult_acc`, `usuario_ult_acc`, `id_privacidad`, `es_editable`, `id_usuario`, `debaja`) VALUES
(23, 'nombre', '2015-12-08', 16, 'Pepe Argento', 'a33.jpg', 'Inspirada en el universo de Star Trek, viajeros perdidos en un planeta desconocido', NULL, NULL, NULL, 2, NULL, 18, 's'),
(24, 'Documentacion sobre Proyecto Final', '2015-03-13', 16, '11', 'a22.jpg', 'Ensayo de materiales de PVC para utilizacion en laboratorio de microbiologia', NULL, NULL, NULL, NULL, NULL, 18, NULL),
(25, 'PHP para la Gilada', '2015-03-13', 17, '12', 'a11.jpg', 'Proyecto de educacion de la ciudad de mexico, material docente de calidad educativa', NULL, NULL, NULL, NULL, NULL, 18, NULL),
(26, 'Antes de que los cuelguen', '2015-03-13', 16, '13', 'a33.jpg', 'Inspirada en el universo de Star Trek, viajeros perdidos en un planeta desconocido', NULL, NULL, NULL, NULL, NULL, 18, NULL),
(27, 'Tesis sobre tabla periodica', '2015-03-15', 16, '16', 'a22.jpg', 'Ensayo de materiales de PVC para utilizacion en laboratorio de microbiologia', NULL, NULL, NULL, NULL, NULL, 18, NULL),
(28, 'El libro negro de la jardineria', '2015-03-15', 17, '12', 'a11.jpg', 'Proyecto de educacion de la ciudad de mexico, material docente de calidad educativa', NULL, NULL, NULL, NULL, NULL, 18, NULL),
(29, 'Matematica I', '2015-03-15', 17, '11', 'a33.jpg', 'Inspirada en el universo de Star Trek, viajeros perdidos en un planeta desconocido', NULL, NULL, NULL, NULL, NULL, 18, NULL),
(30, 'La biblia del bromista', '2015-03-15', 17, '12', 'a22.jpg', 'Ensayo de materiales de PVC para utilizacion en laboratorio de microbiologia', NULL, NULL, NULL, NULL, NULL, 18, NULL),
(31, 'Las 2 torres', '2015-03-15', 17, '13', 'a11.jpg', 'Proyecto de educacion de la ciudad de mexico, material docente de calidad educativa', NULL, NULL, NULL, NULL, NULL, 18, NULL),
(32, 'Todo sobre impresoras', '2015-03-16', 16, '11', 'a33.jpg', 'Inspirada en el universo de Star Trek, viajeros perdidos en un planeta desconocido', NULL, NULL, NULL, NULL, NULL, 18, NULL),
(33, 'mate demo', '2015-03-24', 24, '20', 'a22.jpg', 'Ensayo de materiales de PVC para utilizacion en laboratorio de microbiologia', NULL, NULL, NULL, NULL, NULL, 18, NULL),
(34, 'pepe argento', '2015-04-02', 20, '20', 'a11.jpg', 'Proyecto de educacion de la ciudad de mexico, material docente de calidad educativa', NULL, NULL, NULL, NULL, NULL, 18, NULL);
