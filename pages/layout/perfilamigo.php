            ...
            <div class="col-md-3">
              ...
              <div class="box box-primary">
                <div class="box-body box-profile">
                  ...
                  <a href="#" class="btn btn-primary btn-block"><b>Enviar un mensaje</b></a>
                  <a href="#" class="btn btn-primary btn-block"><b>Dejar de Seguir</b></a>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
              <div class="box box-primary">
              ...
              <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="timeline">
                      aca si es mi perfil, tengo que poder editar mis datos personales.
                      Caso contrario, esta pestaña no la veran usuarios publicos o amigos
                  </div><!-- /.tab-pane -->
                </div><!-- /.tab-content -->
              </div><!-- /.nav-tabs-custom -->
            </div><!-- /.col -->
