...
<html>
    ...
    <body>
        ...
        <div class="wrap">
            ...
            <!---start-content---->
            <div class="content">
                <div class="section group" id="formulario_generos">
                    <div class="box box-default box-solid collapsed-box"> <!--box box-warning-->
                        <div class="box-header with-border">
                            <h3 class="box-title" id="titulo_formulario">Nuevo genero</h3>
                        ...
                        <div class="box-body" >
                            ...
                            <div class="form-group">
                                <button class="btn btn-block btn-default" onclick="enviar_form_generos()">Enviar</button>
                            </div>
                        </div>
                    </div>
                </div>	
