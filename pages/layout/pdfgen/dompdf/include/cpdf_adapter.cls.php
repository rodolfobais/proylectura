...
/* $Id: cpdf_adapter.cls.php 4474 2012-01-30 12:22:27Z cburela $ */
...
class CPDF_Adapter implements Canvas {
   ...
   */
  function page_text($x, $y, $text, $font, $size, $color = array(0,0,0), $adjust = 0, $angle = 0, $head = "") {
    $_t = "text";
    $this->_page_text[] = compact("_t", "x", "y", "text", "font", "size", "color", "adjust", "angle", "head");
  }
