...
if($libro->getDebaja() != NULL){
    echo "<h1>El libro al que esta intentando acceder se encuentra bloqueado por el administrador</h1>";die;
}
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            ...
                            <?php 
                                ...
                                if($libro->getEs_editable()=='n'){
                                    echo '<a href="pdf/'.$idLibro.'.pdf" target="_blank"class="btn btn-primary btn-block"><b>Descargar libro</b></a>';
                                }else{
                                    echo '<a href="'.PROJECT_REL_DIR.'/pages/layout/generarlibropdf.php?id='.$idLibro.'" target="_blank"class="btn btn-primary btn-block"><b>Descargar libro</b></a>';
                                }
                            ?>
                        </div><!-- /.box-body -->
                    </div><!-- /.box -->
              ...
              <!--Fin Perfil general con imagen -->
                <div class="col-md-9">
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content" id="formulario_comentarios">
                            ...
                            <div class="tab-pane" id="colaboracion">
                                <?php 
                                if($idSoli->getId_estado==1){
                                    foreach ($idSoli as $soli) {
                                            
                                            echo "<tr>"
                                            . "<td><a href='#' class='username' onclick=\"refreshDivs('cuerpocentro','pages/layout/perfilsesion.php','id=".$soli->getId_usuario_solicitante()."')\">".$soli->getUsuario()->getNombre()."</a></td>"      
                                            . "</tr>";
                                    }
                                }
                                ?>  
